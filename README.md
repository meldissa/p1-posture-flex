...
Identified issue with iPad Pro where there is a slight horizontal white line after the footer. The social-links class style display inline seems to be causing this white line to appear underneath the footer. Due to time constraints the issue was not resolved.
